...
class Frame(wx.Frame):
    ...
    def __set_layout(self):
        ...
        st_text = wx.StaticText(panel1,label = "Form Input")
        
        st_text.SetFont(wx.Font(wx.FontInfo(14).FaceName("Times New Roman")))
        ...
        sizer.Add(fgridsizer,1,wx.EXPAND)
        fgridsizer.AddGrowableCol(1,1)

        fgridsizer.SetFlexibleDirection( wx.BOTH )
        fgridsizer.SetNonFlexibleGrowMode(wx.FLEX_GROWMODE_ALL)

        label1 =  wx.StaticText(self,id=wx.ID_ANY,label ="Kode")
        fgridsizer.Add(label1,1,wx.EXPAND,self.border)
       
        TextC =  wx.TextCtrl(self,id=wx.ID_ANY)
        fgridsizer.Add(TextC,1,wx.EXPAND,self.border)
        
        label1 =  wx.StaticText(self,id=wx.ID_ANY,label ="Nama")
        fgridsizer.Add(label1,0,wx.EXPAND|wx.ALL,5)
       
        TextC =  wx.TextCtrl(self,id=wx.ID_ANY)
        fgridsizer.Add(TextC,1,wx.EXPAND,self.border)

        label1 =  wx.StaticText(self,id=wx.ID_ANY,label ="No Telp")
        fgridsizer.Add(label1,1,wx.EXPAND,5)
       
        TextC =  wx.TextCtrl(self,id=wx.ID_ANY)
        fgridsizer.Add(TextC,1,wx.EXPAND,self.border)

        label1 =  wx.StaticText(self,id=wx.ID_ANY,label ="Alamat")
        fgridsizer.Add(label1,1,1,5)
